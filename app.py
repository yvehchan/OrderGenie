...
def forecast():
    ...
    if ( dfsize== 0):
        ...
        together_order = []
        for index, row in boughtTogetherPairs.iterrows():
        ...
        return render_template ("forecast.html", comp= company_id, recommend_table=recom_order, last_table=last_order, top_table=top_order, together_table=together_order)  
